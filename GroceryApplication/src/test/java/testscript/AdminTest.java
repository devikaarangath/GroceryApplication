...
//		adminpage.clickOnMoreinfo();
		...
		adminpage.enterUserNameOnUserNameField(newusername).enterPasswordOnPasswordField(newpassword).clickOnUserType().clickOnDropDown().clickOnSave();
...
//		loginPage.rememberMeonRememberMefield();
		...
		adminpage = homepage.clickOnAdminUsers();
//		adminpage.clickOnMoreinfo();
		adminpage.clickOnSearch().enterSearchUserOnUsernameField(existingUser)
			.clickOnSearchUserType().selectSearchUserType().clickOnSearchUser();
